...
import PaginatedShopProducts from './PaginatedShopProducts';

const PaginatedShopItem = ({ itemsPerPage }: any) => {
    ...
    return (
        <>
            <div className='container mx-auto pb-7'>
                {/* <PaginatedShopProducts product={currentItems} isLoading={isLoading} /> */}
...
export default PaginatedShopItem;