        ...
        <div className="container mx-auto py-5">
            ...
            <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-4 py-7">
                ...
                <div className='mx-auto items-center py-12'>
                    {/* <h3 className='text-3xl font-bold text-center text-green-600 uppercase pb-6'>Address</h3> */}
...
// https://i.ibb.co/7JHJ9Z3/pin.png
// https://i.ibb.co/RSY94bw/message.png
// https://i.ibb.co/xC5Lxcb/contact-us.png